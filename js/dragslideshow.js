...
$('body').keydown(colorNav);
	...
	DragSlideshow.prototype._initDragDealer = function() {
		...
		var hash_id = location.hash.replace('#slide','');
		this.dd.setStep(hash_id);
	}
	...
	DragSlideshow.prototype._navigate = function( x, y ) {
		...
		// Change Burmak Yuliya, this script add Active Link menu and add location
